...
export default function Schedule() {
  return (
    <section id="schedule" className="py-24 md:py-32 bg-[#F8FAFC] relative overflow-hidden">
      <div
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          <div className="space-y-6 lg:col-span-1">
            <motion.div
              ...
              className="p-6 rounded-2xl border border-[#E2E8F0] bg-white relative overflow-hidden group hover:border-[#e61435] transition-all duration-300 hover:shadow-md"
            >
              <div
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-[rgba(242,13,73,0.07)] flex items-center justify-center">
                  <Sun className="text-[#e61435]" size={20} />
                </div>
                <div>
                  <div className="font-bold text-[#0F172A] text-base">ຮອບເຊົ້າ</div>
                  <div className="text-[#64748B] text-xs">ຕອນເຊົ້າ</div>
                </div>
              </div>
              <div className="flex items-center gap-2 text-[#e61435]">
                <Clock size={15} />
                <span className="font-bold text-xl">08:00 – 16:00</span>
              </div>
              <div className="text-[#64748B] text-sm mt-1">08:00 – 16:00 ໂມງ</div>
              <div className="mt-4 pt-4 border-t border-[#E2E8F0]">
                <div className="text-[#64748B] text-xs">ວັນຮຽນ</div>
                <div className="text-[#0F172A] text-sm font-semibold mt-1">ວັນຈັນ – ວັນສຸກ</div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl border border-[rgba(217,119,6,0.2)] bg-white relative overflow-hidden group hover:border-[#D97706] transition-all duration-300 hover:shadow-md"
            >
              <div
                className="absolute top-0 left-0 w-full h-1 rounded-t-2xl"
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-[rgba(217,119,6,0.07)] flex items-center justify-center">
                  <Moon className="text-[#D97706]" size={20} />
                </div>
                <div>
                  <div className="font-bold text-[#0F172A] text-base">ຮອບແລງ</div>
                  <div className="text-[#64748B] text-xs">ຕອນແລງ</div>
                </div>
              </div>
              ...
              <div className="text-[#64748B] text-sm mt-1">18:00 – 20:00 ໂມງ</div>
          ...
          >
            <div className="px-6 py-4 border-b border-[#E2E8F0] flex items-center justify-between">
              <div>
                <div className="font-bold text-[#0F172A] text-base">ຕາຕະລາງປະຈຳອາທິດ</div>
            ...
            <div className="grid grid-cols-6 bg-[#F8FAFC]">
              <div className="px-3 py-3 text-[#64748B] text-xs font-semibold tracking-wide">ເວລາ</div>
              {days.map((day) => (
                <div key={day} className="px-2 py-3 text-center">
                  <div className="text-[#0F172A] text-xs font-bold leading-tight">{day}</div>
                </div>
              ))}
            </div>
            ...
            {morningSlots.map((slot, idx) => (
              <div
                ...
                className={`grid grid-cols-6 border-t border-[#E2E8F0] ${
                  idx % 2 === 0 ? "bg-transparent" : "bg-[#F8FAFC]/50"
                }`}
              >
                <div className="px-3 py-3 text-[#64748B] text-xs font-mono whitespace-nowrap">{slot.time}</div>
                {days.map((day) => (
                  <div
                    key={day}
            ...
            <div className="px-6 py-4 border-t border-[rgba(217,119,6,0.15)] bg-[rgba(217,119,6,0.03)] flex items-center gap-3">
              <Moon size={16} className="text-[#D97706] shrink-0" />
              <p className="text-[#64748B] text-sm">
                ຮອບແລງ{" "}
                <span className="text-[#D97706] font-semibold">18:00 – 20:00</span> ມີຈັດຫ້ອງສອນເສີມ
